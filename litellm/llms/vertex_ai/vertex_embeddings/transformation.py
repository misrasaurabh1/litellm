...
class VertexAITextEmbeddingConfig(BaseModel):
    ...
    def map_special_auth_params(self, non_default_params: dict, optional_params: dict):
        mapped_params = _MAPPED_SPECIAL_AUTH_PARAMS  # Use the constant directly

        # Use set intersection to avoid repeated membership checks in loop
...
_MAPPED_SPECIAL_AUTH_PARAMS = {"project": "vertex_project", "region_name": "vertex_location"}
